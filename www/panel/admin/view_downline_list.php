...
if(isset($_GET['user_value']))
{
	...
	{
		header("location:select_user_detail.php?action=view_downline_list");
		exit(EXIT_ERROR);
	}	
...
$fetch_obj->parse_in_downline_org_list_admin($UID,$fso_downline_array,$sso_downline_array,$organisation);
      ...
      <form action="" method="get">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            &nbsp;&nbsp;&nbsp; <a href="../admin/select_user_detail.php?action=view_downline_list">
