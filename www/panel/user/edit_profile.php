...
<?php require_once("../../../library/session_msg.php"); ?>
...
{
 	extract($_POST);
	$msg = $fetch_obj->Update_all();
	if($msg=="ok")
	{
		$temp_filename="edit_profile.php";
		$msg_print="Profile Updated Successfully";
 ...
 ?>
<?php 
$edit_profile = $fetch_obj->edit_profile();
            ...
            <div class="box box-primary">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" d="name" name="name" value="<?php echo $DATA['name'] ?>"  disabled="">
                </div>
                <div class="form-group">
...
$first = $current_year-68;
 ...
 ?>
            ...
            <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control"  style="text-transform:lowercase;" id="email_id" name="email_id" value="<?php echo $DATA['email_id'] ?>" disabled="">
                </div>
              </div>
              <!-- /.box-body --> 
            </div>
  ...
  if(f.billingtoo.checked == true) {
    f.c_local.value = f.p_local.value;
    f.c_city.value = f.p_city.value;
    f.c_state.value = f.p_state.value;
    f.c_pincode.value = f.p_pincode.value;
